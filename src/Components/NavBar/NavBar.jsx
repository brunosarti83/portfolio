...
export default function NavBar() {
  ...
  neon = "text-red-500 font-bold drop-shadow-md"  
  ...
  return (
    ...
    >
      <h1 className="font-work font-extrabold text-[22px] md:self-center ml-4 md:ml-2 bg-gray-500 text-transparent [text-shadow:_0_2px_3px_rgba(255,_255,_255,_0.7)] bg-clip-text max-md:my-8">
        BRUNO SARTI
      </h1>
      <div
        className={`${
      ...
      >
        <ul className="flex max-md:flex-col justify-around md:justify-between max-md:items-center max-md:h-5/6 max-md:my-auto">
          ...
          >
            ...
            {(pathname === RoutesHelper.home || pathname === RoutesHelper.about) && <motion.div className="h-full md:h-[20px] w-full md:w-full absolute max-md:top-0 md:top-[20px] border-red-500 max-md:border-l-[2px] md:border-b-[2px]" layoutId="underline"></motion.div>}
          </li>
          <li
            className={`w-full max-md:h-1/6 md:w-[80px] flex font-source font-semibold my-auto hover:cursor-pointer relative ${
          ...
          >
            ...
            {pathname === RoutesHelper.projects && <motion.div className="h-full md:h-[20px] w-full md:w-full absolute max-md:top-0 md:top-[20px] border-red-500 max-md:border-l-[2px] md:border-b-[2px]" layoutId="underline"></motion.div>}
          </li>
          <li
            className={`w-full max-md:h-1/6 md:w-[80px] flex font-source font-semibold my-auto hover:cursor-pointer relative ${
          ...
          >
            ...
            {pathname === RoutesHelper.feedback && <motion.div className="h-full md:h-[20px] w-full md:w-full absolute max-md:top-0 md:top-[20px] border-red-500 max-md:border-l-[2px] md:border-b-[2px]" layoutId="underline"></motion.div>}
          </li>
