...
export default function NavBar() {
  ...
  return (
    ...
    >
      <h1 className="font-work font-extrabold text-[22px] md:self-center ml-4 md:ml-2 bg-gray-500 text-transparent [text-shadow:_0_2px_3px_rgba(255,_255,_255,_0.7)] bg-clip-text max-md:my-8 hover:cursor-pointer"
