...
export default function Projects() {
  ...
  return (
    <div
      className={`flex flex-col ${dynamicTailwind.containerHeight} bg-[#F0F0F0] relative before:content-[""] before:w-[45vh] before:h-[45vh] before:rounded-[100%] before:absolute before:left-[72%] before:top-[25%] before:bg-[#F0F0F3] before:z-1 before:shadow-inner after:content-[""] after:w-[45vh] after:h-[45vh] after:rounded-[100%] after:absolute after:top-[25%] after:left-[72%] after:bg-[#F0F0F0] after:z-2 after:scale-75 after:shadow-md`}
    >
      {projects.map((project, index) => (
        ...
        >
          ...
          {index === projects.length - 1 && (
            <div
              className={`before:content-[""] before:w-[20vh] before:h-[20vh] before:rounded-[100%] before:absolute before:left-[60%] before:top-[80%] before:bg-[#F0F0F3] before:z-1 before:shadow-inner after:content-[""] after:w-[20vh] after:h-[20vh] after:rounded-[100%] after:absolute after:top-[80%] after:left-[60%] after:bg-[#F0F0F0] after:z-2 after:scale-[65%] after:shadow-md`}
            >
              <div
                className={`before:content-[""] before:w-[15vh] before:h-[15vh] before:rounded-[100%] before:absolute before:left-[73%] before:top-[87%] before:bg-[#F0F0F3] before:z-3 after:content-[""] after:w-[15vh] after:h-[15vh] after:rounded-[100%] after:absolute after:top-[87%] after:left-[73%] after:bg-[#F0F0F0] after:z-5 after:scale-[65%] after:shadow-lg`}
              ></div>
