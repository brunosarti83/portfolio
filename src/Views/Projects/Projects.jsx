      ...
      {projects.map((project, index) => (
        ...
        >
          ...
          {index === projects.length - 1 && (
            <div
              className={`before:content-[""] before:w-[15%] before:h-[15%] before:rounded-[100%] before:absolute before:left-[60%] before:top-[80%] before:bg-gray-100 before:z-1 before:shadow-inner after:content-[""] after:w-[15%] after:h-[15%] after:rounded-[100%] after:absolute after:top-[80%] after:left-[60%] after:bg-[#F0F0F0] after:z-2 after:scale-[65%] after:shadow-md`}
            >
              <div
                className={`before:content-[""] before:w-[10%] before:h-[10%] before:rounded-[100%] before:absolute before:left-[73%] before:top-[87%] before:bg-gray-100 before:z-3 after:content-[""] after:w-[10%] after:h-[10%] after:rounded-[100%] after:absolute after:top-[87%] after:left-[73%] after:bg-[#F0F0F0] after:z-5 after:scale-[65%] after:shadow-lg`}
              ></div>
